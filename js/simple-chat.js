            ...
            <div id="sakura-chat-container" style="display: none; position: fixed; bottom: 20px; right: 20px; width: 400px; height: 580px; background: linear-gradient(145deg, #FADADD 0%, #F8BBD9 30%, #FFE4E1 100%); border-radius: 28px; box-shadow: 0 20px 60px rgba(248, 187, 217, 0.4), 0 12px 40px rgba(250, 218, 221, 0.3), inset 0 2px 0 rgba(255, 255, 255, 0.9); z-index: 9999; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; border: 3px solid rgba(248, 187, 217, 0.5); overflow: hidden; position: relative;">
                ...
                <div style="background: linear-gradient(135deg, #F8BBD9 0%, #FADADD 30%, #F0A6CA 70%, #FFE4E1 100%); color: #5D4E75; padding: 24px; border-radius: 28px 28px 0 0; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 4px 16px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.9); position: relative; border-bottom: 1px solid rgba(255, 255, 255, 0.7);">
                    <div style="display: flex; align-items: center; gap: 16px;">
                        ...
                        <div>
                            <div style="font-weight: 800; font-size: 1.3em; color: #5D4E75; text-shadow: 0 1px 2px rgba(255, 255, 255, 0.9);">AIサクラ</div>
                            <div style="font-size: 0.9em; opacity: 0.85; color: #7A6B8F; font-weight: 600;">益々酒造 AIアシスタント 🌸</div>
                            <div style="font-size: 0.75em; color: #A085B5; margin-top: 2px;">やさしく相談に乗ります</div>
                        </div>
                    </div>
                    <button onclick="closeSakuraChat()" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.8), rgba(248, 187, 217, 0.4)); border: 3px solid rgba(93, 78, 117, 0.3); color: #5D4E75; font-size: 1.6em; cursor: pointer; padding: 8px; border-radius: 50%; width: 44px; height: 44px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.9); font-weight: 700;" onmouseover="this.style.background='linear-gradient(135deg, rgba(255,255,255,0.9), rgba(240,166,202,0.6))'; this.style.transform='scale(1.1)'; this.style.borderColor='rgba(93,78,117,0.5)'" onmouseout="this.style.background='linear-gradient(135deg, rgba(255,255,255,0.8), rgba(248,187,217,0.4))'; this.style.transform='scale(1)'; this.style.borderColor='rgba(93,78,117,0.3)'">×</button>
                </div>
                ...
                <div style="padding: 16px 20px; background: linear-gradient(135deg, #FEFEFD 0%, #F8BBD9 50%, #FFE4E1 100%); display: flex; gap: 12px; flex-wrap: wrap; border-top: 2px solid rgba(248, 187, 217, 0.4); box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.9);">
                    <button onclick="sendQuickMessage('おすすめの日本酒は？')" style="background: linear-gradient(145deg, #F8BBD9 0%, #FADADD 50%, #FFE4E1 100%); border: 2px solid rgba(248, 187, 217, 0.6); border-radius: 22px; padding: 10px 16px; font-size: 0.8em; cursor: pointer; color: #5D4E75; font-weight: 700; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8); position: relative; overflow: hidden;" onmouseover="this.style.transform='translateY(-3px) scale(1.05)'; this.style.boxShadow='0 8px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.9)'; this.style.borderColor='rgba(240, 166, 202, 0.8)'" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8)'; this.style.borderColor='rgba(248, 187, 217, 0.6)'">🌸 おすすめ</button>
                    <button onclick="sendQuickMessage('料理との相性は？')" style="background: linear-gradient(145deg, #F8BBD9 0%, #FADADD 50%, #FFE4E1 100%); border: 2px solid rgba(248, 187, 217, 0.6); border-radius: 22px; padding: 10px 16px; font-size: 0.8em; cursor: pointer; color: #5D4E75; font-weight: 700; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8);" onmouseover="this.style.transform='translateY(-3px) scale(1.05)'; this.style.boxShadow='0 8px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.9)'; this.style.borderColor='rgba(240, 166, 202, 0.8)'" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8)'; this.style.borderColor='rgba(248, 187, 217, 0.6)'">🍽️ ペアリング</button>
                    <button onclick="sendQuickMessage('飲み方を教えて')" style="background: linear-gradient(145deg, #F8BBD9 0%, #FADADD 50%, #FFE4E1 100%); border: 2px solid rgba(248, 187, 217, 0.6); border-radius: 22px; padding: 10px 16px; font-size: 0.8em; cursor: pointer; color: #5D4E75; font-weight: 700; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8);" onmouseover="this.style.transform='translateY(-3px) scale(1.05)'; this.style.boxShadow='0 8px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.9)'; this.style.borderColor='rgba(240, 166, 202, 0.8)'" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 4px 8px rgba(248, 187, 217, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8)'; this.style.borderColor='rgba(248, 187, 217, 0.6)'">🍶 飲み方</button>
                </div>
                ...
                <div style="padding: 20px; display: flex; gap: 12px; background: linear-gradient(135deg, #FEFEFD 0%, #F8BBD9 50%, #FADADD 100%); border-top: 3px solid rgba(248, 187, 217, 0.5); box-shadow: inset 0 2px 0 rgba(255, 255, 255, 0.9), 0 -6px 12px rgba(248, 187, 217, 0.2); position: relative;">
                    ...
                    <input type="text" id="sakura-input" placeholder="✨ メッセージを入力してください... 🌸" style="flex: 1; padding: 16px 20px; border: 3px solid rgba(248, 187, 217, 0.6); border-radius: 28px; outline: none; font-size: 1em; background: linear-gradient(135deg, #FFFFFF 0%, #FEFEFD 100%); color: #5D4E75; box-shadow: inset 0 3px 6px rgba(248, 187, 217, 0.15), 0 2px 8px rgba(248, 187, 217, 0.1); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); font-weight: 500;" onkeypress="handleEnterKey(event)" onfocus="this.style.borderColor='rgba(240, 166, 202, 0.8)'; this.style.boxShadow='inset 0 3px 6px rgba(248, 187, 217, 0.2), 0 0 0 4px rgba(248, 187, 217, 0.15), 0 4px 12px rgba(248, 187, 217, 0.2)'; this.style.transform='translateY(-1px)'" onblur="this.style.borderColor='rgba(248, 187, 217, 0.6)'; this.style.boxShadow='inset 0 3px 6px rgba(248, 187, 217, 0.15), 0 2px 8px rgba(248, 187, 217, 0.1)'; this.style.transform='translateY(0)'">
                    
                    <button onclick="sendMessage()" style="background: linear-gradient(135deg, #F8BBD9 0%, #F0A6CA 40%, #FADADD 100%); color: #5D4E75; border: 2px solid rgba(248, 187, 217, 0.6); border-radius: 50%; width: 52px; height: 52px; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); font-size: 1.4em; position: relative; overflow: hidden; font-weight: 700;" onmouseover="this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 10px 24px rgba(248, 187, 217, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9)'; this.style.borderColor='rgba(240, 166, 202, 0.8)'" onmouseout="this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='0 6px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8)'; this.style.borderColor='rgba(248, 187, 217, 0.6)'">
    ...
    function addUserMessage(message) {
        ...
        const messageHTML = `
            <div style="display: flex; justify-content: flex-end; margin-bottom: 24px; animation: messageSlideIn 0.4s ease-out;">
                <div style="background: linear-gradient(135deg, #F8BBD9 0%, #F0A6CA 50%, #FADADD 100%); color: #5D4E75; padding: 18px 22px; border-radius: 25px 25px 8px 25px; max-width: 80%; box-shadow: 0 6px 16px rgba(248, 187, 217, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8); position: relative; backdrop-filter: blur(8px); border: 2px solid rgba(248, 187, 217, 0.3);">
                    ...
                    <div style="position: absolute; bottom: -2px; right: 10px; font-size: 0.75em; opacity: 0.8; font-weight: 500; color: #7A6B8F;">You</div>
                </div>
            </div>
        `;
        ...
        const messageHTML = `
            <div style="display: flex; justify-content: flex-start; margin-bottom: 28px; animation: messageSlideIn 0.5s ease-out;">
                <div style="display: flex; align-items: flex-start; gap: 16px; max-width: 90%;">
                    ...
                    <div style="background: linear-gradient(135deg, #FFFFFF 0%, #FEFEFD 50%, #F8F9FA 100%); color: #5D4E75; padding: 20px 24px; border-radius: 12px 28px 28px 28px; box-shadow: 0 6px 20px rgba(248, 187, 217, 0.25), 0 3px 12px rgba(240, 166, 202, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.9); border: 2px solid rgba(248, 187, 217, 0.4); position: relative; backdrop-filter: blur(4px);">
                        <div style="font-size: 1.05em; line-height: 1.7; white-space: pre-line; font-weight: 500; letter-spacing: 0.2px; color: #5D4E75;">${message}</div>
                        <div style="position: absolute; bottom: 6px; right: 16px; font-size: 0.75em; color: #A085B5; font-weight: 700; opacity: 0.9; text-shadow: 0 1px 2px rgba(255,255,255,0.9);">AIサクラ</div>
